# The run_Plot1.R script reads the data file in the current working directory 
# and creates a histogram plot in a png file plot1.png
...
# STEP FOUR (a)
# setup the png device per project requirements i.e. "plot1.png" filename
# Other parameters such as size=480 appear to be the default value for png device.
# IMPORTANT : The plot1.png file is created in the current working directory
  png(filename="plot1.png")

# STEP FOUR (b) 
# Create the histogram and setup the appropriate labels and axis headings
  with(consumptionData_tbf, hist(Global_active_power, 
                                 col="red",
